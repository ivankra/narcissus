...
function mixinHandler(redirect, catchall) {
    ...
    return {
        ...
        defineProperty: function(target, name, desc) {
            return Reflect.defineProperty(targetFor(name), name, desc);
        },
        ...
        has: hasMux,
        hasOwn: hasMux,
        get: function(target_, name, receiver) {
            var target = targetFor(name);
            return target[name];
        },
        set: function(target_, name, val, receiver) {
            var target = targetFor(name);
            target[name] = val;
            return true;
        },
...
function makePassthruHandler(obj) {
    ...
    return {
        ...
        get: function(target, name, receiver) { return obj[name]; },

        // bad behavior when set fails in non-strict mode
        set: function(target, name, val, receiver) { obj[name] = val; return true; },
        enumerate: function() {
            var result = [];
